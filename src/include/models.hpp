...
namespace model_kendalls_tau_namespace {
...
class model_kendalls_tau : public prob_grad {
private:
    int N;
    vector<int> x_rank;
    vector<int> y_rank;
public:
    model_kendalls_tau(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_kendalls_tau_namespace::model_kendalls_tau";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
        ...
        pos__ = 0;
        N = vals_i__[pos__++];
        validate_non_negative_index("x_rank", "N", N);
        context__.validate_dims("data initialization", "x_rank", "int", context__.to_vec(N));
        validate_non_negative_index("x_rank", "N", N);
        x_rank = std::vector<int>(N,int(0));
        vals_i__ = context__.vals_i("x_rank");
        pos__ = 0;
        size_t x_rank_limit_0__ = N;
        for (size_t i_0__ = 0; i_0__ < x_rank_limit_0__; ++i_0__) {
            x_rank[i_0__] = vals_i__[pos__++];
        }
        validate_non_negative_index("y_rank", "N", N);
        context__.validate_dims("data initialization", "y_rank", "int", context__.to_vec(N));
        validate_non_negative_index("y_rank", "N", N);
        y_rank = std::vector<int>(N,int(0));
        vals_i__ = context__.vals_i("y_rank");
        pos__ = 0;
        size_t y_rank_limit_0__ = N;
        for (size_t i_0__ = 0; i_0__ < y_rank_limit_0__; ++i_0__) {
            y_rank[i_0__] = vals_i__[pos__++];
        }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("x", "N", N);
        context__.validate_dims("initialization", "x", "vector_d", context__.to_vec(N));
        // generate_declaration x
        vector_d x(static_cast<Eigen::VectorXd::Index>(N));
        for (int j1__ = 0U; j1__ < N; ++j1__)
            x(j1__) = vals_r__[pos__++];
        try {
            writer__.ordered_unconstrain(x);
        } catch (const std::exception& e) { 
        ...
        try {
            writer__.ordered_unconstrain(y);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        if (jacobian__)
            x = in__.ordered_constrain(N,lp__);
        else
            x = in__.ordered_constrain(N);

        Eigen::Matrix<T__,Eigen::Dynamic,1>  y;
        (void) y;  // dummy to suppress unused var warning
        if (jacobian__)
            y = in__.ordered_constrain(N,lp__);
        else
            y = in__.ordered_constrain(N);
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                current_statement_begin__ = 18;
                stan::math::assign(get_base1_lhs(x2,i,"x2",1), get_base1(x,get_base1(x_rank,i,"x_rank",1),"x",1));
                current_statement_begin__ = 19;
                stan::math::assign(get_base1_lhs(y2,i,"y2",1), get_base1(y,get_base1(y_rank,i,"y_rank",1),"y",1));
            }
            current_statement_begin__ = 22;
            stan::math::assign(get_base1_lhs(T,1,1,"T",1), 1);
            current_statement_begin__ = 23;
            stan::math::assign(get_base1_lhs(T,1,2,"T",1), rho);
            current_statement_begin__ = 24;
            stan::math::assign(get_base1_lhs(T,2,1,"T",1), rho);
            current_statement_begin__ = 25;
            stan::math::assign(get_base1_lhs(T,2,2,"T",1), 1);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        for (int i0__ = 0; i0__ < N; ++i0__) {
            if (stan::math::is_uninitialized(x2[i0__])) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: x2" << '[' << i0__ << ']';
                throw std::runtime_error(msg__.str());
            }
        }
        for (int i0__ = 0; i0__ < N; ++i0__) {
            if (stan::math::is_uninitialized(y2[i0__])) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: y2" << '[' << i0__ << ']';
                throw std::runtime_error(msg__.str());
            }
        }
        for (int i0__ = 0; i0__ < 2; ++i0__) {
        ...
        try {
            {
                ...
                Eigen::Matrix<T__,Eigen::Dynamic,1>  m(static_cast<Eigen::VectorXd::Index>(2));
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    stan::math::assign(get_base1_lhs(m,1,"m",1), get_base1(x2,i,"x2",1));
                    current_statement_begin__ = 32;
                    stan::math::assign(get_base1_lhs(m,2,"m",1), get_base1(y2,i,"y2",1));
                    current_statement_begin__ = 33;
                    lp_accum__.add(multi_normal_log(m,stan::math::to_row_vector(stan::math::array_builder<double >().add(0).add(0).array()),T));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_kendalls_tau_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector_d x = in__.ordered_constrain(N);
        vector_d y = in__.ordered_constrain(N);
        double rho = in__.scalar_lub_constrain(-(1),1);
        ...
        stan::math::initialize(x2, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(x2,DUMMY_VAR__);
        validate_non_negative_index("y2", "N", N);
        vector<double> y2(N, 0.0);
        ...
        try {
            ...
            stan::math::assign(tau, ((2 / stan::math::pi()) * asin(rho)));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
